...
class _TotalLessonTimeApiService implements TotalLessonTimeApiService {
  ...
  Future<HttpResponse<int>> getTotalLessonTime() async {
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<HttpResponse<int>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    ...
    final value = _result.data!['total'] as int;
